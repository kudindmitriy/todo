...
<div id="signup" style="display:none; margin-top:50px" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
  <div class="panel panel-info">
    <div class="panel-heading">
      <div class="panel-title" style="display: inline-block; width: 70% !important;">Sign Up</div>
      <div style="display: inline-block; float: right;"><a id="signinlink" href="#login" onclick="$('#signup').hide(); $('#login').show()">Log In</a></div>
    </div>
