...
class NavWidget extends Widget
{
  function display()
  {
    if ($this->is_login()) {
?>
      <li><a href="<?php echo $this->to_url('new-todo'); ?>">Add task</a></li>
      <li class="dropdown" role="presentation">
        <a class="dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Filter <span class="caret"></span></a>
      ...
      <li><a href="<?php echo $this->to_url('todo-home'); ?>">Task list</a></li>
